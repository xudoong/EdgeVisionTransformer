...
class PatcherContext:
    ...
    def get_context_data(self, data_key,layerindex):
        #print('self.context_data',self.context_data)
        return self.context_data[layerindex][data_key]
...
class ReplacementModule(nn.Module):
    ...
    def get_context_data(self, key,module_name):
        layerindex=int(module_name.split('.')[3])
        #print(layerindex)

        return self._context.get_context_data(key,layerindex)
...
class ModulePatcher:
    ...
    def get_context_module(self, child_module_name, child_module, kind="default", **kwargs):
        ...
        if self.context.has_module_context(key):
            ...
            print('here context',child_module_name)
