...
import re
from transformers import BertConfig, BartConfig, T5Config, ViTConfig
...
class ViTStructure(ModelStructure):
    PATTERN_PREFIX = "vit.encoder.layer.[0-9]+."
    LAYER_PATTERNS = dict(
